...
public class MainActivity2 extends AppCompatActivity {
        ...
        sendQueryButton.setOnClickListener(v->{
            ...
            GeminiPro.getResponse(chatModel, query, new ResponseCallBack() {
                ...
                public void onResponse(String response){
                    ...
                    populateChatBody("DUT HEALTH BOT", response,getDate());
                ...
                public void onError(Throwable throwable){
                    ...
                    populateChatBody("Dut Health Bot","Sorry i'm having trouble understanding that. Please try again",getDate());
                    progressBar.setVisibility(View.GONE);
    ...
    private String getDate() {
        ...
        if (instant != null && formatter != null) {
            ...
            // Return a default value or handle the null case according to your application logic
